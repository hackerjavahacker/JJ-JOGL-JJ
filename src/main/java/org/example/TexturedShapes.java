...
public class TexturedShapes {
     ...
     */
    public static void cube(GL2 gl, double side) {
        cube(gl, side,true);
    }
     ...
     */
    public static void uvSphere(GL2 gl, double radius, int slices, int stacks) {
        uvSphere(gl, radius, slices, stacks,true);
    }
     ...
     */
    public static void uvCylinder(GL2 gl, double radius, double height, int slices, int stacks, int rings) {
        uvCylinder(gl, radius, height, slices, stacks, rings,true);
    }
     ...
     * in the xy-plane and its axis along the positive z-axis.
     */
    public static void uvCone(GL2 gl, double radius, double height, int slices, int stacks, int rings) {
        uvCone(gl, radius, height, slices, stacks, rings,true);
    }
     ...
     */
    public static void uvTorus(GL2 gl, double outerRadius, double innerRadius, int slices, int rings) {
        uvTorus(gl, outerRadius, innerRadius, slices, rings,true);
    }
